...
function arrays(;extmod=false)
    ...
    macros = [
        "Macros" => [
            "@assert", "@b_str", "@boundscheck", "@coalesce", "@inbounds", "@show",
            "@showtime", "@simd", "@something", "@view", "@views"
        ]
    ]
    methods = [
        "Methods" => [
            "Concatenation"     => [
                "cat", "hcat", "hvcat", "hvncat", "stack", "vcat"
            ],
            "Constructors"      => [
                "falses", "fill", "ones", "repeat", "similar", "trues", "vectˣ", "zeros",
            ],
            "Dimension, Size & Indices"    => [
                "axes", "checked_lengthˣ", "dropdims", "eachindex", "eachcol", "eachrow",
                "eachslice", "elsizeˣ", "first", "firstindex", "get", "getindex", "indexin",
                "keys", "keytype", "last", "lastindex", "mapslices", "ndims", "nextind",
                "permutedims", "prevind", "reverse", "selectdim", "setindexˣ", "size",
                "sizeof", "to_indexˣ", "to_indices"
            ],
            "In-Place"          => [
                "accumulate!", "all!", "any!", "append!", "broadcast!", "circcopy!",
                "circshift!", "clamp!", "conj!", "copy!", "copyfirst!ˣ", "copyto!",
                "count!", "cumprod!", "cumsum!", "delete!", "deleteat!", "digits!",
                "empty!", "extrema!", "fill!", "filter!", "findmax!", "findmin!",
                "hex2bytes!", "insert!", "intersect!", "invpermute!", "keepat!", "kron!",
                "map!", "maximum!", "minimum!", "partialsort!", "partialsortperm!",
                "permute!", "permutedims!", "pop!", "popat!", "popfirst!", "prepend!",
                "prod!", "push!", "pushfirst!", "read!", "readbytes!", "replace!",
                "resize!", "reverse!", "setdiff!", "sizehint!", "sort!", "sortperm!",
                "splice!", "sum!", "symdiff!", "union!", "unique!", "unsafe_copyto!"
            ],
            "Loop"              => [
                "enumerate", "foreach", "pairs", "zip"
            ],
            "Mathematical"      => [
                "accumulate", "acos", "acot", "acotd", "acoth", "acsc", "acscd", "acsch",
                "adjoint", "argmax", "argmin", "asec", "asecd", "asech", "asin", "asind",
                "asinh", "atan", "atand", "atanh", "canonicalize2ˣ", "cis", "cmp", "conj",
                "cos", "cosd", "cosh", "cot", "coth", "csc", "csch", "cumprod", "cumsum",
                "diff", "exp", "extrema", "intersect", "inv", "invperm", "kron", "lcm",
                "log", "max", "maximum", "min", "minimum", "minmax", "muladd", "prod",
                "rot180", "rotl90", "rotr90", "sec", "sech", "setdiff", "sin", "sincos",
                "sincosd", "sind", "sinh", "sqrt", "sum", "symdiff", "tan", "tand", "tanh",
                "transpose", "union", "unique"
            ],
            "Missing & Nothing" => [
            ...
            "Sorting"           => [
                "insorted", "partialsort", "partialsortperm", "searchsorted",
                "searchsortedfirst", "searchsortedlast", "sort", "sortperm", "sortslices",
            ],
            "True/False"        => [
                "all", "allequal", "allunique", "any", "checkbounds",
                "checkbounds_indicesˣ", "has_offset_axesˣ", "hasfastinˣ", "ifelse", "in",
                "isa", "isapprox", "isassigned", "isbits", "isdisjoint", "isdoneˣ",
                "isempty", "isequal", "isgreaterˣ", "isless", "ismissing", "ismutable",
                "isnothing", "isone", "isperm", "isreal", "issetequal", "issorted",
                "issubset", "isunordered", "iszero", "promote"
            ],
            "Type-Conversion"   => [
                "cconvertˣ", "collect", "complex", "convert", "float", "oftype",
                "promote", "promote_shape", "string", "transcode", "vec"
            ],
            "Others"            => [
                "PipeBuffer", "SecretBuffer!ˣ", "alignmentˣ", "broadcast", "bytes2hex",
                "circshift", "copy", "copymutableˣ", "dataidsˣ", "deepcopy", "display",
                "dump", "eltype", "empty", "hash", "identity", "iterate", "join", "length",
                "map", "mightaliasˣ", "objectid", "only", "parent", "parentindices",
                "print", "print_matrix_rowˣ", "print_matrix_vdotsˣ", "print_matrixˣ",
                "println", "printstyled", "real", "redisplay", "reim", "reinterpret",
                "replace", "replace_with_centered_markˣ", "repr",
                "require_one_based_indexingˣ", "reshape", "restˣ", "reverseind", "show",
                "split_restˣ", "stride", "strides", "summary", "summarysizeˣ", "typeassert",
                "typeof", "unaliascopyˣ", "unaliasˣ", "unsafe_wrap", "valtype", "values",
                "view", "zero"
            ]
        ]
    ]
    types = [
        "Types" => [
            "AbstractArray", "AbstractMatrix", "AbstractSlices", "AbstractVecOrMat",
            "AbstractVector", "Array", "BitArray", "BitMatrix", "BitVector", "Bitsˣ",
            "CartesianIndex", "CartesianIndices", "Colon", "ColumnSlices", "Cvoid",
            "DataType", "DenseArray", "DenseMatrix", "DenseVecOrMat", "DenseVector", "Dims",
            "Generatorˣ", "IndexCartesian", "IndexLinear", "IndexStyle", "IteratorEltypeˣ",
            "IteratorSizeˣ", "LinearIndices", "LogicalIndexˣ", "Matrix", "Missing",
            "Nothing", "Pair", "PartialQuickSort", "PermutedDimsArray", "Ref",
            "ReinterpretArrayˣ", "RowSlices", "ScalarIndexˣ", "Slices", "Sliceˣ", "Some",
            "StridedArray", "StridedMatrix", "StridedVecOrMat", "StridedVector", "SubArray",
            "UndefInitializer", "VecOrMat", "Vector"
        ]
    ]
    operators = [
        "Operators" => [
    ...
    stdlib = [
        "Stdlib" => [
            ...
            "Printf.PositionCounterˣ", "Printf.Specˣ", "Printf.formatˣ", "Statistics.cor",
            "Statistics.cov", "Statistics.mean", "Statistics.mean!", "Statistics.median",
            "Statistics.median!", "Statistics.middle", "Statistics.quantile",
            "Statistics.quantile!", "Statistics.std", "Statistics.stdm", "Statistics.var",
            "Statistics.varm"
        ]
    ]
