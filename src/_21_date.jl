...
"""
function datetime(; extmod=false)
    constants = [
        "Constants" => [
            "RoundDown", "RoundFromZero", "RoundNearest", "RoundNearestTiesAway",
            "RoundNearestTiesUp", "RoundToZero", "RoundUp", "Dates.Apr", "Dates.April",
            "Dates.Aug", "Dates.August", "Dates.Dec", "Dates.December", "Dates.Feb",
            "Dates.February", "Dates.Fri", "Dates.Friday", "Dates.ISODateFormat",
            "Dates.ISODateTimeFormat", "Dates.ISOTimeFormat", "Dates.Jan", "Dates.January",
            "Dates.Jul", "Dates.July", "Dates.Jun", "Dates.June", "Dates.Mar",
            "Dates.March", "Dates.May", "Dates.Mon", "Dates.Monday", "Dates.Nov",
            "Dates.November", "Dates.Oct", "Dates.October", "Dates.RFC1123Format",
            "Dates.Sat", "Dates.Saturday", "Dates.Sep", "Dates.September", "Dates.Sun",
            "Dates.Sunday", "Dates.Thu", "Dates.Thursday", "Dates.Tue", "Dates.Tuesday",
            "Dates.Wed", "Dates.Wednesday"
        ]
    ]
    macros = [
        "Macros" => [
            "Dates.@dateformat_str", "@assert", "@doc", "@show", "@showtime"
        ]
    ]
    methods = [
        "Methods" => [
            "Accessor"          => [
                "Dates.day", "Dates.hour", "Dates.microsecond", "Dates.millisecond",
                "Dates.minute", "Dates.month", "Dates.monthabbr", "Dates.monthday",
                "Dates.nanosecond", "Dates.quarterˣ", "Dates.second", "Dates.week",
                "Dates.year", "Dates.yearmonth", "Dates.yearmonthday"
            ],
            "Adjusting"         => [
                "Dates.firstdayofmonth", "Dates.firstdayofquarter", "Dates.firstdayofweek",
                "Dates.firstdayofyear", "Dates.lastdayofmonth", "Dates.lastdayofquarter",
                "Dates.lastdayofweek", "Dates.lastdayofyear", "Dates.tofirst",
                "Dates.tolast", "Dates.tonext", "Dates.toprev"
            ],
            "Epoch & TimeZones" => [
                "Dates.date2epochdaysˣ", "Dates.datetime2epochmsˣ", "Dates.datetime2julian",
                "Dates.datetime2rata", "Dates.datetime2unix", "Dates.epochdays2dateˣ",
                "Dates.epochms2datetimeˣ", "Dates.julian2datetime", "Dates.rata2datetime",
                "Dates.unix2datetime"
            ],
            "Formatters"        => [
                "Dates.formatˣ",
            ...
            "Query"             => [
                "Dates.dayabbr", "Dates.dayname", "Dates.dayofmonth", "Dates.dayofquarter",
                "Dates.dayofweek", "Dates.dayofweekofmonth", "Dates.dayofyear",
                "Dates.daysinmonth", "Dates.daysinyear", "Dates.daysofweekinmonth",
                "Dates.monthname", "Dates.quarterofyear"
            ],
            "Rounding"          => [
                "Dates.floorceilˣ", "ceil", "floor", "round", "trunc"
            ],
            "True/False"        => [
                "Dates.isleapyear", "in", "isa", "isfinite",
            ],
            "Others"            => [
                "Dates.canonicalize", "Dates.defaultˣ", "Dates.now",
                "Dates.parse_componentsˣ", "Dates.periodsˣ", "Dates.today",
                "Dates.tryparsenext_coreˣ", "Dates.tryparsenext_internalˣ",
                "Dates.validargsˣ", "Dates.valueˣ", "display", "dump", "eps", "gcd", "gcdx",
                "getfield", "getproperty", "identity", "lcm", "length", "mod", "objectid",
                "one", "parse", "print", "println", "printstyled", "redisplay", "rem",
                "repr", "show", "sign", "string", "summary", "time", "timedwait",
    ...
    types = [
        "Types" => [
            "DataType", "Dates.AbstractDateTokenˣ", "Dates.CompoundPeriodˣ", "Dates.Date",
            "Dates.DateFormat", "Dates.DateLocaleˣ", "Dates.DatePeriod", "Dates.DateTime",
            "Dates.Day", "Dates.Hour", "Dates.Instantˣ", "Dates.Microsecond",
            "Dates.Millisecond", "Dates.Minute", "Dates.Month", "Dates.Nanosecond",
            "Dates.Period", "Dates.Quarter", "Dates.Second", "Dates.Time",
            "Dates.TimePeriod", "Dates.TimeType", "Dates.TimeZone", "Dates.UTC",
            "Dates.UTInstantˣ", "Dates.Week", "Dates.Year"
        ]
    ]
    operators = [
        "Operators" => [
